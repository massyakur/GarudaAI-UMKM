# Deprecated: Clerk + Supabase Integration Setup Guide

> NEVADA now talks directly to a FastAPI backend with JWT auth. The Clerk/Supabase setup below is kept only for historical reference and is not used by the current app.
